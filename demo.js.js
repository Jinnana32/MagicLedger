...
const Transaction = require('./core/transaction/transaction');
const TransactionManager = require('./core/transaction/TransactionManager');
...
app.post('/connect-to-node', (req, res) => {
    ...
    .then(function(){
        ...
        console.log(`Node ${connectionNodeUrl} was added to the network.`);
    });
...
app.post('/broadcast-node', (req, res) => {
    ...
    console.log('Added Nodes to this network');
